...
namespace Forge.SolidWorks
{
    ...
    public static class CreateCylinder
    {
        ...
        public static bool IsIntent(string cmd)
        {
            ...
            // shaft/axle/spindle/pin are just cylinders — "create a shaft" routes here (create_cylinder) too. Note
            // tube/pipe are claimed by the more specific CreateTube first wherever the dispatch order allows it.
            bool obj = Regex.IsMatch(c, @"\b(cylinde(?:r|rical)|pillar|rod|tube|pipe|shaft|axle|spindle|pin)\b");

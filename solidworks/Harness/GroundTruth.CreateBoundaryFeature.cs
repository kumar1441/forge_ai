...
{
    /// <summary>
    /// INDEPENDENT ground truth for create_boundary_feature (tool 210, PROBE). Same shape as GroundTruth.AddLoft:
    /// own feature walk for Forge-Boundary + independent solid-body count/volume sum. Read-only.
    /// </summary>
    public static partial class GroundTruth
    {
        public static JObject MeasureCreateBoundaryFeature(IModelDoc2 model)
        {
            var mo = new JObject();
            ...
            try
            {
                ...
                while (f != null)
                {
                    ...
                    if (nm != null && nm.StartsWith("Forge-Boundary", StringComparison.OrdinalIgnoreCase)) { hasForge = true; break; }

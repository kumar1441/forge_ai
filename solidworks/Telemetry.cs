...
{
    /// <summary>
    /// Trial telemetry — the "ton of information" the trial exists to generate. Fire-and-forget:
    ...
    {
        private const string Url = "https://www.getforge.build/api/trial/event";
            ...
            string questionSummary = null)
        {
            try
            {
                var payload = new
                {
                    trial_id = TrialInit.TrialId ?? "uninit",
